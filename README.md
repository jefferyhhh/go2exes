...
- **共享库复用** — `shared/` 中的 Excel 读写、日志等模块被所有工具共用
...
```go
import "github.com/yourname/go2exes/shared/excelutil"
```
